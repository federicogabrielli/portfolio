...
export function Astronaut(props) {
  ...
  const ySpring = useSpring(yPosition, {damping: 90 });
  useEffect(()=>{ySpring.set(-1);}, [ySpring])
  useFrame(()=>{group.current.position.y = ySpring.get();}, [ySpring])

  return (
    <group ref={group} {...props} dispose={null}
    rotation={[-Math.PI / 2, -0.2, 1.9]} scale={props.scale || 0.25} position={props.position || [2.5, -0.7, 0]}>
